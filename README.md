...
👉 **[Download Demo Installer](https://github.com/ZiYuCai1984/ZYC.Framework/releases/download/v1.4.8/ZYC.Framework.Setup.1.4.8.exe)**
...
```bash
dotnet tool install --global ZYC.Framework.CLI --version 1.4.8
dotnet tool update --global ZYC.Framework.CLI --version 1.4.8
...
```bash
dotnet add package ZYC.Framework.Alpha --version 1.4.8
```
