...
👉 **[Download Demo Installer](https://github.com/ZiYuCai1984/ZYC.Framework/releases/download/v1.3.3/ZYC.Framework.Setup.1.3.3.exe)**
...
```bash
dotnet add package ZYC.Framework.Alpha --version 1.3.3
```
