...
public class PseudoConsole : IDisposable
{
    ...
    {
        PseudoConsoleApi.ResizePseudoConsole(Handle.DangerousGetHandle(),
    ...
    {
        public ConPtyClosePseudoConsoleSafeHandle(IntPtr preexistingHandle, bool ownsHandle = true) : base(
