...
{
    protected DepPropHelper()
    {
        throw new Exception("Should not be instanced");
    }
        ...
        Expression<Func<CONTROL_TYPE, PROP_TYPE>> PropToSet)
    {
        ...
        return DependencyProperty.Register(propName, typeof(PROP_TYPE), typeof(CONTROL_TYPE),
            new FrameworkPropertyMetadata(null,
                (target, value) => CoerceReadOnlyHandle(prop.SetMethod, target, value)));
    }
