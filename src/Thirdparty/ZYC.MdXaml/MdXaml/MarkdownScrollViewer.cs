...
using ZYC.MdXaml.LinkActions;
using MdStyle = ZYC.MdXaml.MarkdownStyle;
using System.ComponentModel;
using System.Windows.Media.Media3D;
using System.Windows.Threading;
using System.Threading.Tasks;
using ZYC.MdXaml.Extensions;
...
namespace ZYC.MdXaml
{
    ...
    public class MarkdownScrollViewer : FlowDocumentScrollViewer, IUriContext
    {
        ...
        public MarkdownScrollViewer()
        {
            ...
            //!WARNING Add ExtensionsPluginSetup for MarkdownScrollViewer
            var plugins = new MdXamlPlugins();
            plugins.Setups.Add(new ExtensionsPluginSetup());
            Plugins = plugins;
