...
[Register]
internal partial class ApplyFaultedView
{
    public ApplyFaultedView(ILifetimeScope lifetimeScope)
    {
    ...
    private void OnApplyFaultedViewLoaded(object sender, RoutedEventArgs e)
    {
