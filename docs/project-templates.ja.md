...
```bash
dotnet tool install -g ZYC.Framework.CLI --version 1.3.7
dotnet tool update -g ZYC.Framework.CLI --version 1.3.7
```
...
```bash
zyc new Acme.Tools --template modular --output ./Acme.Tools --package-version 1.3.7
```
